...
.. csv-table:: 患者基本情報
    ...
    "郵便番号", "PID-11", "ランダムな日本の郵便番号を生成。市町村および町域レベルで住所と一致するよう生成される。"
...
.. csv-table:: 処方オーダー情報
    ...
    "薬剤名", "RXE-2", "元データを参照。"
    "与薬量－最小", "RXE-3", "いくつかのパターンからランダムに選択(軟膏などでは空欄)。"
    "与薬単位", "RXE-5", "可能な限り薬剤名から推定。不可の場合は固定値。"
    "与薬剤形", "RXE-6", "可能な限り薬剤名から推定。不可の場合は固定値。"
    "調剤量", "RXE-10", "可能な限り、繰返しパターンなど参考に計算。"
    "調剤単位", "RXE-11", "可能な限り薬剤名から推定。"
    "処方箋番号", "RXE-15", "衝突しないランダムな番号を生成。"
    "1日あたりの総投与量", "RXE-19", "可能な限り、繰返しパターンなど参考に計算。"
...
.. csv-table:: 注射オーダー情報
    ...
    "注射種別", "RXE-2", "JHSI 表 0002-注射種別に基づく固定値 (00)"
    "与薬量－最小", "RXE-3", "成分量などもとに計算。"
    "与薬単位", "RXE-5", "可能な限り薬剤名から推定。"
    "与薬剤形", "RXE-6", "固定値 (INJ)"
    "調剤量", "RXE-10", "成分量などもとに計算。"
    "調剤単位", "RXE-11", "可能な限り薬剤名から推定。"
    "処方箋番号", "RXE-15", "衝突しないランダムな番号を生成。"
